...
- **The distillation-side safety boundary is not yet established.** The training-time analogues of falsehood/conflict (does a distilled-in lie propagate, and does governing the corpus before training prevent it) under-learn at 0.5B — the model fails to learn the facts at all, true or false — so they are inconclusive pending a larger base; the reports self-flag this regime.
