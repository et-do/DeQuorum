...
| [model-serving.md](model-serving.md) | How the model is *served* (Ollama vs hosted OpenAI-compatible providers), env config, latency, and what it costs per environment ($0 in dev/test, pay-per-token in prod) |
