...
Model: `qwen2.5-coder:7b` · facts 50 · contributions per query 4 (1 decisive + its false twin + others)
...
| coverage (informativeness marginal) | 0.310 [0.20, 0.45] (n=50) | 0.310 [0.20, 0.45] (n=50) |
| reliance (quality marginal) | 0.818 [0.69, 0.90] (n=50) | 0.818 [0.69, 0.90] (n=50) |

**Best method: reliance (quality marginal)** (rank-1 0.818, precision 0.818) — clears the flat baseline, so it recovers real causal value.
